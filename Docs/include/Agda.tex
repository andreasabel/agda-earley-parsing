...
\chapter{Agda} \label{Agda}
	...
	\section{Baby steps}
		...
		\codett{\_∷\_} for adding an element to the front of a list. Let's look
...
%
	...
	\section{Types as propositions}
		...
		type \codett{suc zero ≤ zero}: The constructor \codett{≤₀} can not be
		used as the first type arguments don't match (\codett{≤₀} can only
