...
\chapter{Parsing} \label{Parsing}
	...
	optional type \codett{∣}. This grammar will have conforming strings that
	...
	Here, a proposition of the form \codett{G ⊢ u ∈ α} means that, given a
	grammar \codett{G}, the sequence of tokens \codett{u} conforms to the
	structure \codett{α}. For instance, if \codett{A} is a non-terminal with a
	...
	Here, a proposition of the form \codett{G ⊢ v / w ∈ α} means that,
	...
	\codett{conc} and \codett{empt} rules:
